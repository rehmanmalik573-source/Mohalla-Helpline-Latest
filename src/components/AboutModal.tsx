      ...
      <div className="relative bg-white rounded-3xl max-w-md w-full p-5 sm:p-6 shadow-2xl border border-slate-200 space-y-4 animate-in zoom-in-95 duration-150">
        ...
        <div className="space-y-3 text-xs text-slate-600 leading-relaxed max-h-80 overflow-y-auto pr-1">
          <div className="bg-amber-50/70 p-3.5 rounded-2xl border border-amber-200/80 space-y-1.5">
            ...
            <p>
              {language === 'hi'
                ? 'मोहल्ला हेल्पलाइन आपके इलाके के कुशल व भरोसेमंद कारीगरों (प्लंबर, इलेक्ट्रीशियन, पेंटर, कारपेंटर आदि) को सीधे आपके घर तक बिना किसी बिचौलिये के जोड़ता है।'
                : 'Mohalla Helpline directly connects skilled and verified neighborhood service professionals with local households without middlemen commissions.'}
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2.5">
            <div className="p-3 bg-slate-50 rounded-2xl border border-slate-200/80">
              ...
              <div className="font-bold text-slate-900">{language === 'hi' ? 'स्थानीय कारीगर' : 'Local Professionals'}</div>
          ...
          <div className="p-3 bg-slate-900 text-white rounded-2xl space-y-1">
            <div className="font-bold flex items-center gap-1.5 text-xs text-amber-400">
              ...
              <span>{language === 'hi' ? 'ग्राहक सुरक्षा गारंटी' : 'Customer Protection Guarantee'}</span>
            </div>
            <p className="text-[11px] text-slate-300">
              {language === 'hi' ? 'सत्यापित कारीगर, पारदर्शी दरें और काम पूरा होने पर ही भुगतान।' : 'Verified technicians, transparent rates, and pay only after complete satisfaction.'}
            </p>
          </div>
        </div>
      </div>

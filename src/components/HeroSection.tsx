...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section id="mohalla-hero" className="bg-transparent pt-3 pb-2 px-3.5 sm:px-4 max-w-4xl mx-auto relative z-30">
      {/* Top Banner Row: Logo + Text on Left, Team Illustration on Right */}
      <div className="flex items-center justify-between gap-3 relative overflow-hidden">
        ...
        <div className="flex-1 space-y-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-base sm:text-lg font-black tracking-tight text-slate-900 leading-tight">
                MOHALLA <span className="text-amber-600">HELPLINE</span>
              </div>
          ...
          {/* Main Question Heading: "आपको किस चीज़ की मदद चाहिए?" */}
          <div className="pt-1">
            <h1 className="text-xl sm:text-2xl font-black tracking-tight text-slate-900 leading-tight">
              {language === 'hi' ? (
                <>
                  आपको किस सेवा में<br />
                  <span className="text-amber-600">मदद चाहिए?</span>
                </>
              ) : (
                <>
        ...
        {/* Right Side: Pro Team Arch Illustration (Slightly increased by ~18% for prominence & clarity) */}
        <div className="w-[9.75rem] sm:w-[13.5rem] md:w-[14.5rem] h-[7.25rem] sm:h-[9.5rem] md:h-[10rem] shrink-0 relative rounded-2xl overflow-hidden shadow-xs border border-amber-100/90 bg-gradient-to-b from-amber-50 to-orange-100 flex items-center justify-center">
          <img
            src={heroIllustration}
            alt="Mohalla Help Verified Service Professionals Team"
            className="w-full h-full object-cover object-center select-none scale-105 transition-transform duration-300"
          ...
          <div className="absolute bottom-1.5 left-1.5 right-1.5 px-2 py-0.5 bg-white/95 backdrop-blur-xs rounded-md text-[9.5px] sm:text-[10.5px] font-black text-slate-900 text-center shadow-xs truncate">
            {language === 'hi' ? 'भरोसेमंद मोहल्ला कारीगर' : 'Trusted Local Pros'}
          </div>
        </div>
      </div>

      {/* Search Bar with Clean White Pill and Orange Circular Button */}

      ...
      >
        ...
        <div className="p-5 overflow-y-auto space-y-4 flex-1">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-amber-50 border border-amber-200 rounded-2xl p-3.5 text-center flex flex-col items-center justify-center gap-1.5">
              <ShieldCheck className="w-5 h-5 text-amber-600" />
              <span className="text-xs font-black text-slate-900">{language === 'hi' ? '24x7 सहायता' : '24x7 In-App Help'}</span>
              <span className="text-[10px] text-amber-800 font-bold uppercase tracking-wider">
                {language === 'hi' ? 'मोहल्ला हेल्पलाइन' : 'Customer Support'}
              </span>
            </div>

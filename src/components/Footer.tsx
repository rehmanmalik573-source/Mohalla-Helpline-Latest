      ...
      <div className="max-w-4xl mx-auto px-4 space-y-6">
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-black text-white">
                MOHALLA <span className="text-amber-400">HELPLINE</span>
              </span>
            </div>
        ...
        <div className="space-y-2">
          <div className="text-xs font-bold text-slate-400 uppercase tracking-wider">
            {language === 'hi' ? 'सेवा डायरेक्टरी' : 'Service Directory'}
          </div>
        ...
        <div className="pt-4 border-t border-slate-800/80 flex flex-col sm:flex-row items-center justify-between gap-2 text-[11px] text-slate-500">
          <p>© {new Date().getFullYear()} MOHALLA HELPLINE - {t.tagline}</p>
          <div className="flex items-center gap-1">
            <span>{language === 'hi' ? 'आपके मोहल्ले की सेवा में समर्पित' : 'Dedicated to serving your neighborhood'}</span>

        ...
        {confirmedRequest ? (
          ...
          <form onSubmit={handleSubmit} className="p-5 sm:p-6 overflow-y-auto space-y-4 flex-1">
            ...
            <div className="bg-amber-50/70 border border-amber-200 rounded-2xl p-3 flex items-center justify-between text-xs text-amber-950">
              ...
              <span className="font-black text-xs text-slate-900 bg-white/80 px-2 py-1 rounded-lg border border-amber-200">{language === 'hi' ? `अनुमानित: ${activeCategory.avgRate || '₹250'}` : `Estimated: ${activeCategory.avgRate || '₹250'}`}</span>
            </div>
